...
**Current status:** v0.3.0 released; all five phases complete. Releases are automated (changesets + trusted publishing + staged approval). Next: real-world use, then v1.0.0.
